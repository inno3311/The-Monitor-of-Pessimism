...
@Config
public final class MecanumDriveFaster
{
...
//        public double trackWidthTicks = 4037.330655170419;
        public double inPerTick = 0.00293764705;
        public double lateralInPerTick = 0.0020896274543765556;
        public double trackWidthTicks = 4190.164237001522;

        // feedforward parameters (in tick units)
//        public double kS = 1.1799891957204;
//        public double kV = 0.0004087247214;
//        public double kA = 0.00003;
        public double kS = 1.2048273881052252;
        public double kV = 0.0004023912144485954;
        ...
        public double axialGain = 7.0;  //4.0;
...
//    }
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveFaster.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveFaster.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveFaster.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveFaster.this.rightFront));
    ...
    public MecanumDriveFaster(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;

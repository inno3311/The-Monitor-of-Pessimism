...
@Autonomous(name="SpecimenRun_4_take2", group="Linear OpMode")
public final class HighChamberSpecimens_4 extends LinearOpMode {
...
//                .splineToConstantHeading(new Vector2d(48, -43), Math.toRadians(270), new TranslationalVelConstraint(25)) //slow down for sample drop off
                ...
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(48, -10), Math.toRadians(90), new TranslationalVelConstraint(40)) //go fetch center sample
                .splineToConstantHeading(new Vector2d(70, -10), Math.toRadians(270), new TranslationalVelConstraint(40)) //move centered to center sample
                ...
                //.waitSeconds(.20)  //TODO was 1 then .5
                .setReversed(true)
                .afterTime( 0, slide.action( SLIDE_TO_WALL, 1)) //lower and extend the arm to the position of the specimen on the wall
                .afterTime(0, wrist.action(0.7))
                .afterTime(1, elbow.action( ELBOW_TO_WALL, .75))

                //.setTangent(Math.toRadians(0))

                //.splineTo(new Vector2d(15, -28), Math.toRadians(270))
...
//                .splineToConstantHeading(new Vector2d(50, -48), Math.toRadians(270), new TranslationalVelConstraint(10)) //slow down run into the specimen on the wall
                ...
                ////////////////////////////////////////////////////////////////////////////////////
                /// Pick up Specimen #4 from Wall and Hang it
                ...
                .afterTime(0, slide.action( SLIDE_TO_WALL, 1)) //lower and extend the arm to the position of the specimen on the wall
                .afterTime(0, wrist.action(0.7))
                .afterTime(0.5, elbow.action( ELBOW_TO_WALL, .75))

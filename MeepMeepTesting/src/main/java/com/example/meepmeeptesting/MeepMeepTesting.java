...
//           .splineToConstantHeading(new Vector2d(-20, -12), Math.toRadians(0)) //park
      ...
      RoadRunnerBotEntity myBotMesloh2 = new DefaultBotBuilder(meepMeep)
            // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
            .setConstraints(60, 60, Math.toRadians(180), Math.toRadians(180), 15)
            .build();

      myBotMesloh2.runAction(myBot2.getDrive().actionBuilder(new Pose2d(24,-50, Math.toRadians(270)))
            .setReversed(true)
...
//            .strafeTo(new Vector2d(60,-50))
            ...
            .strafeTo(new Vector2d(60,-60),new TranslationalVelConstraint(10))
            //close claw
            .setReversed(true)
            ...
            .setReversed(true)
            .splineToSplineHeading(new Pose2d(50,-60,Math.toRadians(270)),Math.toRadians(270))
            .waitSeconds(1)
            .setReversed(true)
            .splineToSplineHeading(new Pose2d(5,-26,Math.toRadians(90)),Math.toRadians(90))
...
//                .afterTime(0, claw.action(CLAW_CLOSE)) //close claw
           ...
           // Speciman 3
           .setReversed(true)
           .splineToSplineHeading(new Pose2d(47,-56, Math.toRadians(270)), Math.toRadians(270), new TranslationalVelConstraint(100)) //move to chamber and hang spec
           .setReversed(true)
           .splineToSplineHeading(new Pose2d(0,-21, Math.toRadians(90)), Math.toRadians(90), new TranslationalVelConstraint(100)) //move to chamber and hang spec
           // Speciman 4
           .setReversed(true)
           .splineToSplineHeading(new Pose2d(47,-56, Math.toRadians(0)), Math.toRadians(270), new TranslationalVelConstraint(100)) //move to chamber and hang spec
           .splineToConstantHeading(new Vector2d(52,-56), Math.toRadians(0), new TranslationalVelConstraint(10)) //move to chamber and hang spec
           .setReversed(true)
           .splineToSplineHeading(new Pose2d(0,-21, Math.toRadians(90)), Math.toRadians(90), new TranslationalVelConstraint(100)) //move to chamber and hang spec
